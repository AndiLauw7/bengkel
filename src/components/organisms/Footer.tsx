...
const Footer: FC = () => {
  ...
  return (
    ...
    //   </div>
    // </footer>
    <footer className="bg-gray-800 border-t border-gray-700/50 w-full overflow-x-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
          <div>
            <Logo />
            <p className="mt-4 text-gray-400 text-sm break-words">
              Bengkel Spesialis Performa & Service Rutin Motor Injeksi/Karbu di
              Tangerang.
            </p>
          </div>
            ...
            <div className="space-y-4">
              <div className="flex items-start">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-gray-400 hover:text-blue-400 transition duration-200 text-sm break-words"
                >
                  {addressText}
                </a>
              </div>

              <p className="flex items-center text-gray-400 text-sm break-words">
                <Phone size={18} className="text-red-500 mr-3 flex-shrink-0" />
                <a
                  href={phoneHref}
                  className="hover:text-red-500 transition duration-200"
